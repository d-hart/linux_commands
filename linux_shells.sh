...
echo 'export PROJECT=MERCURY' >> ~/.profile # Used to set the $PROJECT variable and append it to the ~/.profile Profile scripts file
export PS1="[\d]\u@\h:\w\$" # Used to set or change the custom prompt
